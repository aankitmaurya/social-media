...
from .models import User, Post, LikePost
from django.contrib.auth.decorators import login_required
from .utils import find_no_of_likes_received_by_user
...
def index(request):
    ...
    data = {
        ...
        "already_liked_post_ids_of_current_user": user.like_post.values_list('post_id',
                                                                             flat=True) if user.is_authenticated else []
    }
